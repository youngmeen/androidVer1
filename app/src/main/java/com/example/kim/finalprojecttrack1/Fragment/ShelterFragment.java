...
import com.example.kim.finalprojecttrack1.Data.MyItem2;
...
public class ShelterFragment extends Fragment
    ...
    private ClusterManager<MyItem2> mClusterManager;// MyItem을 관리하는 ClusterManager
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        this.googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(DEFAULT_LOCATION,14));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_shetter, container, false);
    ...
    public String loadJSONFromAsset() {
        ...
        try {
            InputStream is = getContext().getAssets().open("test1.json");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mClusterManager = new ClusterManager<>(getContext().getApplicationContext(), googleMap);
        for (int i = 0; i < obj.length(); i++) {
            ...
            try {
                ...
                tel = obj.getJSONObject(i).getString("tel");
            } catch (JSONException je) {
                je.printStackTrace();
            }

            MyItem2 offsetItem = new MyItem2(x, y, title, tel);
            mClusterManager.addItem(offsetItem);
            googleMap.moveCamera(CameraUpdateFactory.newLatLng(offsetItem.getPosition()));
